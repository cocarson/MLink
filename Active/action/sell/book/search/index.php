...
<div class="row">
	...
	<div id="main-container" class="large-8 large-centered columns light-background large-radius">
		...
		<h1>People looking for your book</h1>

		<script type="text/javascript">

		function createBookDiv(itemBuy, callback) {

			var bookId = itemBuy.get('textbook').id;
			var userId = itemBuy.get('user').id;
			...
			query.first({
				success: function(object) {
					...
					div += '<li style="margin-bottom:0 !important;"><h3 style="margin-bottom:10px !important;">$' + itemBuy.get("maxPay") + '</h3></li>';
					div += '<li><a price="' + itemBuy.get('maxPay') + '" user="' + userId +'"book="' + bookId + '" href="#" style="margin-bottom:0 !important;" class="button small small-radius">Contact</a></li>';
					div += '</ul>';
					div += '</div>';
					div += '</div>';
		...
		$(document).ready(function() {
			...
			query.greaterThan('maxPay', parseInt(maxPay));	
